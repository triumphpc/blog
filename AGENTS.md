...
0. **Минимум 10K символов.** Каждая статья — не менее 10 000 символов (без учёта front matter). Если получается короче — значит тема не раскрыта: не хватает технической глубины, примеров или сравнения подходов. Лучше углубить один аспект, чем поверхностно пройти по десяти.
